...
*/
    ...
    {
        $request = $this->serviceManager->get('Request');
        $uri = UriFactory::factory('http://zff2.my.phpcloud.com/zf2widdercomplete/');
        $request->setUri($uri);
        ...
        $controllerLoader = $this->serviceManager->get('ControllerLoader');
        $controllerLoader->setFactory('HootAndHoller\Service\IndexControllerFactory', function () {
            return new \HootAndHoller\Controller\IndexController;
        });
        $this->application->bootstrap();
    }
